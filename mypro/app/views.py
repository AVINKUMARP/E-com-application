...
from .models import Watch,CartItem,Checkout
...
def checkout(request):
    if request.method=="POST":
        ...
        print(first_name)
        check_out=Checkout.objects.create(first_name=first_name,last_name=last_name,email=email,address=address,country=country,state=state,phone=phone)
    return render(request,'checkout.html')

def full_remove(request): # Update urls.py so product_id is not needed.
    cart = CartItem.objects.get.all()
